...
private fun contains(ranges: IntArray, cp: Int): Boolean {
    var lo = 0
...
internal inline fun String.forEachCodePoint(block: (cp: Int, width: Int, charCount: Int) -> Unit) {
    ...
    while (i < length) {
        ...
        block(cp, codePointWidth(cp), charCount)
        i += charCount
    }
}
...
fun String.takeDisplayWidth(maxWidth: Int): String {
...
fun String.padDisplayEnd(width: Int, pad: Char = ' '): String {
